...
public class FileUpload implements Command{
	...
	public String excute(HttpServletRequest request, HttpServletResponse response)
		...
		String uploadPath = request.getSession().getServletContext().getRealPath("/images"); // getSession는 session 기본객체/ getServletContext는 application 기본객체/ images는 폴더명이고, url폴더의 실제경로를 구해옴
